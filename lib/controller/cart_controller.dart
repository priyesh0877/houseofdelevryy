...
class CartController extends GetxController implements GetxService {
  ...
  double calculationCart(){
    ...
    _cartList.forEach((cartModel) {
      ...
      _availableList.add(DateConverter.isAvailable(cartModel.product.availableTimeStarts, cartModel.product.availableTimeEnds, time: DateTime.now()));
