...
import 'package:houseofdelevryy/data/model/response/coupon_model.dart';
        ...
        if(deliveryCharge > 0) {
          if (_coupon.minPurchase < order) {
            ...
            showCustomSnackBar('${'the_minimum_item_purchase_amount_for_this_coupon_is'.tr} '
                '${PriceConverter.convertPrice(_coupon.minPurchase, discount: 0,discountType: 'k')} '
                '${'but_you_have'.tr} ${PriceConverter.convertPrice(order, discount: 0,discountType: 'k')}');
            _coupon = _coupon;
            _discount = 0;
          }
        }else {
