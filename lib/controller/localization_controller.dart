...
class LocalizationController extends GetxController implements GetxService {
  ...
  void setLanguage(Locale locale) {
    ...
    try {
      _addressModel = AddressModel.fromJson(jsonDecode(sharedPreferences.getString(AppConstants.USER_ADDRESS).toString()));
    }catch(e) {}
    apiClient.updateHeader(
      sharedPreferences.getString(AppConstants.TOKEN).toString(), _addressModel == null ? null : _addressModel.zoneIds,
      locale.languageCode,
    );
