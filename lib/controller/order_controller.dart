...
import 'package:houseofdelevryy/data/model/response/distance_model.dart';
...
import 'package:houseofdelevryy/data/model/response/timeslote_model.dart';
...
class OrderController extends GetxController implements GetxService {
  ...
  Future<void> getRunningOrders(int offset, {bool notify = true, bool fromHome = false}) async {
    if(offset == 1) {
      _runningOffsetList = [];
      _runningOffset = 1;
      _runningOrderList = _runningOrderList;
      if(notify) {
        update();
      }
    }
  ...
  Future<void> getHistoryOrders(int offset, {bool notify = true}) async {
    if(offset == 1) {
      _historyOffsetList = [];
      _historyOrderList = _historyOrderList;
      if(notify) {
        update();
      }
    }
