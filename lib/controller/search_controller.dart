...
class SearchController extends GetxController implements GetxService {
  ...
  void setSearchMode(bool isSearchMode) {
    ...
    if(isSearchMode) {
      ...
      _prodResultText = '';
      _restResultText = '';
      _allRestList = _allRestList;
      _allProductList = _allProductList;
      _searchProductList = _searchProductList;
      _searchRestList = _searchRestList;
      _sortIndex = -1;
  ...
  void sortFoodSearchList() {
    ...
    if(_isAvailableFoods || _isDiscountedFoods) {
      if(_isAvailableFoods) {
        _searchProductList.removeWhere((product) => !DateConverter.isAvailable(product.availableTimeStarts, product.availableTimeEnds, time: DateTime.now()));
      }
