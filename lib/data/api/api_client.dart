...
import 'package:houseofdelevryy/data/model/response/error_response.dart';
...
class ApiClient extends GetxService {
  ...
  Future<Response> postData(String uri, dynamic body, {required Map<String, String> headers, required Map query}) async {
    try {
      debugPrint('====> API Call: $uri\nHeader: $_mainHeaders');
