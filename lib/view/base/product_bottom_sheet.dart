...
import 'package:houseofdelevryy/view/base/confirmation_dialog.dart';
...
import 'package:houseofdelevryy/view/base/discount_tag.dart';
import 'package:houseofdelevryy/view/base/discount_tag_without_image.dart';
import 'package:houseofdelevryy/view/base/quantity_button.dart';
import 'package:houseofdelevryy/view/base/rating_bar.dart';
import 'package:houseofdelevryy/view/screens/checkout/checkout_screen.dart';
import 'package:houseofdelevryy/view/screens/subscription/subscription_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetBuilder<ProductController>(builder: (productController) {
        ...
        bool _isAvailable = DateConverter.isAvailable(widget.product.availableTimeStarts, widget.product.availableTimeEnds, time: DateTime.now());
            ...
            Padding(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  (widget.product.image != null && widget.product.image.isNotEmpty) ? Padding(padding: const EdgeInsets.only(right: 10.0),
                    child: InkWell(
                      ...
                      child: Stack(children: [
                        ...
                        DiscountTag(discount: _discount, discountType: _discountType, fromTop: 20, fontSize: priceWithAddons,),
                      ]),
                    ),
                  ) : SizedBox.shrink(),
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Row(children: [
                        price > priceWithDiscount ? Text(
                          '${PriceConverter.convertPrice(_startingPrice, discount: 0,discountType: 'j')}'
                              '${_endingPrice != null ? ' - ${PriceConverter.convertPrice(_endingPrice, discount: 0,discountType: 'k')}' : ''}',
                        ...
                        (widget.product.image != null && widget.product.image.isNotEmpty)? SizedBox.shrink()
                            : DiscountTagWithoutImage(discount: _discount, discountType: _discountType, fontSize: priceWithAddons,),
                      ]),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: productController.addOnActiveList[index]
                                ? [BoxShadow(color: Colors.grey, blurRadius: 5, spreadRadius: 1)] : null,
                          ),
                          child: Column(children: [
                            Expanded(
                              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                ...
                                SizedBox(height: 5),
                                Text(
                                  widget.product.addOns[index].price > 0 ? PriceConverter.convertPrice(widget.product.addOns[index].price, discount: 0,discountType: 'k') : 'free'.tr,
                ...
                Row(children: [
                  ...
                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  Text(PriceConverter.convertPrice(priceWithAddons, discount: 0,discountType: 'k'), style: robotoBold.copyWith(color: Theme.of(context).primaryColor)),
                ]),
                SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
