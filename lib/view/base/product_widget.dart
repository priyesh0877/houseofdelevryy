...
import 'package:houseofdelevryy/view/base/not_available_widget.dart';
import 'package:houseofdelevryy/view/base/product_bottom_sheet.dart';
...
class ProductWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if(isRestaurant) {
      ...
      _isAvailable = DateConverter.isAvailable(product.availableTimeStarts, product.availableTimeEnds, time: DateTime.now());
    }
      ...
      onTap: () {
        if(isRestaurant) {
          ...
          ResponsiveHelper.isMobile(context) ? Get.bottomSheet(
            ProductBottomSheet(product: product, inRestaurantPage: inRestaurant, isCampaign: isCampaign, cart: null,cartIndex: index,),
            backgroundColor: Colors.transparent, isScrollControlled: true,
          ) : Get.dialog(
            Dialog(child: ProductBottomSheet(product: product, inRestaurantPage: inRestaurant, isCampaign: isCampaign, cart: null,cartIndex: index,)),
          );
        }
      },
      child: Container(
            ...
            child: Row(children: [
              ...
              (_image != null && _image.isNotEmpty) ? Stack(children: [
                ...
                DiscountTag(
                  ...
                  freeDelivery: isRestaurant ? restaurant.freeDelivery : false, fontSize: _discount,
                ),
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  isRestaurant ? RatingBar(
                    ...
                    _discount > 0 ? Text(
                      PriceConverter.convertPrice(product.price, discount: 0,discountType: 'k'),
