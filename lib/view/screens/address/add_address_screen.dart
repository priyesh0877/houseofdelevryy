...
import 'package:houseofdelevryy/view/screens/location/widget/permission_dialog.dart';
...
class AddAddressScreen extends StatefulWidget {
  ...
  AddAddressScreen({required this.fromCheckout, required this.zoneId, required this.address});
...
class _AddAddressScreenState extends State<AddAddressScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: widget.address == null ? 'add_new_address'.tr : 'update_address'.tr, onBackPressed: (){},),
        ...
        return GetBuilder<LocationController>(builder: (locationController) {
          ...
          return Column(children: [
            ...
            Expanded(child: Scrollbar(child: SingleChildScrollView(
              ...
              child: Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    child: Stack(clipBehavior: Clip.none, children: [
                      GoogleMap(
                        ...
                        onMapCreated: (GoogleMapController controller) {
                          ...
                          if(widget.address == null) {
                            locationController.getCurrentLocation(true, mapController: controller, defaultLatLng: _initialPosition);
                          }
                        },
                      ),
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: () => _checkPermission(() {
                            locationController.getCurrentLocation(true, mapController: locationController.mapController, defaultLatLng: _initialPosition);
                          }),
                          child: Container(
                            width: 30, height: 30,
                ...
                MyTextField(
                  ...
                  onChanged: (text) => locationController.setPlaceMark(text), onSubmit:(){},onTap: (){}, fillColor: Colors.white, key: GlobalKey(),
                ),
                SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                ...
                MyTextField(
                  ...
                  capitalization: TextCapitalization.words, onSubmit: (){},onTap:(){},key: GlobalKey(),fillColor: Colors.white,onChanged:(){}
                ),
                SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                ...
                MyTextField(
                  ...
                  controller: _contactPersonNumberController, onSubmit: (){},onTap: (){},fillColor: Colors.white,key: GlobalKey(), onChanged: (){},
                ),
                SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                ...
                MyTextField(
                  ...
                  controller: _streetNumberController, onSubmit: (){},onChanged:(){},fillColor: Colors.black,key: GlobalKey(),onTap:(){},
                ),
                SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                  ...
                  children: [
                    Expanded(
                      child: MyTextField(
                        ...
                        controller: _houseController, onSubmit: (){},onChanged:(){},fillColor: Colors.black,key: GlobalKey(),onTap:(){},
                      ),
                    ),
                    ...
                    Expanded(
                      child: MyTextField(
                        ...
                        controller: _floorController, nextFocus: FocusNode(),onTap:(){},key: GlobalKey(),fillColor: Colors.black,onChanged: (){}, onSubmit: (){},
                      ),
                    ),
                  ],
                ),
            ...
            Container(
              ...
              padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
              child: !locationController.isLoading ? CustomButton(onPressed: (){}, buttonText: (""), margin: EdgeInsets.all(20), width: 200, height: 100, fontSize: 25, icon: Icons.access_time_rounded);
