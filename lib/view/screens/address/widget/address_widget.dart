...
class AddressWidget extends StatelessWidget {
  ...
  AddressWidget({required this.address, required this.fromAddress, required this.onRemovePressed, required this.onEditPressed,
    required this.onTap, this.fromCheckout = false});
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: fromCheckout ? null : [BoxShadow(color: Colors.grey, blurRadius: 5, spreadRadius: 1)],
          ),
          child: Row(children: [
