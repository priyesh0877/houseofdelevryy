...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initState() {
    ...
    if (_isLoggedIn) {
      ...
      widget.fromCart
          ...
          Get
              .find<CartController>()
              .cartList as Iterable<CartModel>)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
          title: 'checkout'.tr, onBackPressed: ErrorWidget.builder),
      body: _isLoggedIn
                          ...
                          if (restController.restaurant != null) {
                            _cartList.forEach((cartModel) {
                              ...
                              cartModel.addOnIds.forEach((addOnId) {
                                for (AddOns addOns in cartModel.product
                                    .addOns) {
                              ...
                              double _dis = (restController.restaurant
                                  .discount !=
                                  null &&
                              ...
                              String _disType = (restController.restaurant
                                  .discount !=
                                  null &&
                                  DateConverter.isAvailable(
                                      restController
                            ...
                            if (restController.restaurant != null &&
                              ...
                              if (restController.restaurant.discount
                                  .maxDiscount !=
                                  0 &&
                                  restController.restaurant.discount
                                      .maxDiscount <
