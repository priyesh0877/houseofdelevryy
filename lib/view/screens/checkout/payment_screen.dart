...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void _initData() async {
    browser = MyInAppBrowser(orderID: widget.orderModel.id.toString(), orderAmount: widget.orderModel.orderAmount, windowId: null, initialUserScripts: UnmodifiableListView(source));
...
class MyInAppBrowser extends InAppBrowser {
  ...
  MyInAppBrowser({required this.orderID, required this.orderAmount, required int windowId, required UnmodifiableListView<UserScript> initialUserScripts})
