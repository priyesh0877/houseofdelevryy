...
import 'package:houseofdelevryy/view/base/cart_widget.dart';
import 'package:houseofdelevryy/view/screens/cart/cart_screen.dart';
import 'package:houseofdelevryy/view/screens/dashboard/widget/bottom_nav_item.dart';
import 'package:houseofdelevryy/view/screens/dashboard/widget/running_order_view_widget.dart';
import 'package:houseofdelevryy/view/screens/favourite/favourite_screen.dart';
import 'package:houseofdelevryy/view/screens/home/home_screen.dart';
import 'package:houseofdelevryy/view/screens/menu/menu_screen.dart';
import 'package:houseofdelevryy/view/screens/order/order_screen.dart';
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: ResponsiveHelper.isDesktop(context) ? SizedBox() : GetBuilder<OrderController>(builder: (orderController) {
          ...
          return (orderController.isRunningOrderViewShow && (orderController.runningOrderList != null && orderController.runningOrderList.length > 0))
              ? RunningOrderViewWidget(key: null,) : BottomAppBar(
            elevation: 5,
            notchMargin: 5,
