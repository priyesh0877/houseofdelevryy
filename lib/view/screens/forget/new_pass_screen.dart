...
class _NewPassScreenState extends State<NewPassScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: widget.fromPasswordChange ? 'change_password'.tr : 'reset_password'.tr, onBackPressed: (){},),
            ...
            Container(
              ...
              child: Column(children: [
                ...
                CustomTextField(
                  ...
                  prefixIcon: Images.lock,
                  isPassword: true,
                  onSubmit: (text) => GetPlatform.isWeb ? _resetPassword() : null, nextFocus: FocusNode(), onChanged: (){},
                ),
