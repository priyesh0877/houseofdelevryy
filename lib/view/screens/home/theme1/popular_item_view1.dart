                      ...
                      child: Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Stack(children: [
                          ...
                          DiscountTag(
                            ...
                            discountType: productController.getDiscountType(_productList[index]), fontSize: double.infinity,
                          ),
                                ...
                                Expanded(
                                  child: Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                                    _productList[index].discount > 0 ? Flexible(child: Text(
                                      PriceConverter.convertPrice(productController.getStartingPrice(_productList[index]), discount: 0,discountType: 'k'),
