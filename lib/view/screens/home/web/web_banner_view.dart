                ...
                return Row(children: [
                  ...
                  Expanded(child: InkWell(
                    ...
                    child: ClipRRect(
                      ...
                      child: CustomImage(
                        image: '$_baseUrl1/${bannerController.bannerImageList[index1]}', fit: BoxFit.cover, height: 220, width: double.infinity,
                      ),
                    ),
                  )),
                  ...
                  Expanded(child: _hasSecond ? InkWell(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(Dimensions.RADIUS_SMALL),
                      child: CustomImage(
                        image: '$_baseUrl2/${bannerController.bannerImageList[index2]}', fit: BoxFit.cover, height: 220, width: double.infinity,
                      ),
                    ),
                  ) : SizedBox()),
