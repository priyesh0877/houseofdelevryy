      ...
      return Column(
        children: [
          Padding(
            ...
            child: TitleWidget(title: isPopular ? 'popular_restaurants'.tr : '${'new_on'.tr} ${AppConstants.APP_NAME}', onTap: (){} ,),
          ),
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Stack(children: [
                      ...
                      DiscountTag(
                        ...
                        discountType: 'percent', freeDelivery: _restaurantList[index].freeDelivery, fontSize: double.infinity,
                      ),
