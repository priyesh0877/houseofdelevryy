                        ...
                        Stack(children: [
                          ...
                          DiscountTag(
                            ...
                            discountType: campaignController.itemCampaignList[index].restaurantDiscount > 0 ? 'percent'
                                : campaignController.itemCampaignList[index].discountType, fontSize: double.infinity,
                          ),
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                              ...
                              Row(
                                children: [
                                  Expanded(
                                    child: Text(
                                      PriceConverter.convertPrice(campaignController.itemCampaignList[index].price, discount: 0,discountType: 'k'),
                                      style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeSmall),
                                    ),
                                  ),
