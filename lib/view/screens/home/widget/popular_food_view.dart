                      ...
                      child: Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Stack(children: [
                          ...
                          DiscountTag(
                            ...
                            discountType: _foodList[index].discountType, fontSize: double.infinity,
                          ),
                                  ...
                                  Expanded(
                                    child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      _foodList[index].discount > 0 ? Flexible(child: Text(
                                        PriceConverter.convertPrice(productController.getStartingPrice(_foodList[index]), discount: 0,discountType: 'k'),
