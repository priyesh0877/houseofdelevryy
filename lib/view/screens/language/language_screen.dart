...
import 'package:houseofdelevryy/view/screens/language/widget/language_widget.dart';
...
class ChooseLanguageScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: (fromMenu || ResponsiveHelper.isDesktop(context)) ? CustomAppBar(title: 'language'.tr, isBackButtonExist: true, onBackPressed: (){},) : null,
      body: SafeArea(
