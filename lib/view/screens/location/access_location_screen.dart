...
import 'package:houseofdelevryy/view/base/custom_loader.dart';
...
class AccessLocationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: 'set_location'.tr, isBackButtonExist: fromHome, onBackPressed: (){},),
      ...
      CustomButton(
        ...
        onPressed: () async {
          _checkPermission(() async {
            Get.dialog(CustomLoader(), barrierDismissible: false);
            AddressModel _address = await Get.find<LocationController>().getCurrentLocation(true, mapController: null, defaultLatLng: null);
