...
import 'package:houseofdelevryy/view/screens/location/widget/location_search_dialog.dart';
              ...
              onMapCreated: (GoogleMapController mapController) {
                ...
                if (!widget.fromAddAddress) {
                  Get.find<LocationController>()
                      .getCurrentLocation(false, mapController: mapController, defaultLatLng: _initialPosition);
                }
              },
            ...
            Positioned(
              ...
              child: FloatingActionButton(
                ...
                onPressed: () => _checkPermission(() {
                  Get.find<LocationController>()
                      .getCurrentLocation(false, mapController: _mapController, defaultLatLng: _initialPosition);
                }),
              ),
            ),
            Positioned(
