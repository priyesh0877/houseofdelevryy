...
import 'package:houseofdelevryy/data/model/response/order_details_model.dart';
...
import 'package:houseofdelevryy/view/screens/order/widget/order_product_widget.dart';
import 'package:houseofdelevryy/view/screens/review/rate_review_screen.dart';
            ...
            Expanded(child: Scrollbar(child: SingleChildScrollView(
              ...
              child: Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Text(PriceConverter.convertPrice(_itemsPrice, discount: (0),discountType: ('jh')), style: robotoRegular),
                ]),
                SizedBox(height: 10),

                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Text('addons'.tr, style: robotoRegular),
                  Text('(+) ${PriceConverter.convertPrice(_addOns, discount: (0),discountType: ('jh'))}', style: robotoRegular),
                ]),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Text(PriceConverter.convertPrice(_subTotal, discount: (0),discountType: ('jh')), style: robotoMedium),
                ]),
                SizedBox(height: 10),

                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Text('discount'.tr, style: robotoRegular),
                  Text('(-) ${PriceConverter.convertPrice(_discount, discount: (0),discountType: ('jh'))}', style: robotoRegular),
                ]),
                SizedBox(height: 10),
                ...
                _couponDiscount > 0 ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Text(
                    '(-) ${PriceConverter.convertPrice(_couponDiscount, discount: (0),discountType: ('jh'))}',
                    style: robotoRegular,
                  ),
                ]) : SizedBox(),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Text('(+) ${PriceConverter.convertPrice(_tax, discount: (0),discountType: ('jh'))}', style: robotoRegular),
                ]),
                SizedBox(height: 10),
                ...
                (_order.orderType != 'take_away' && Get.find<SplashController>().configModel.dmTipsStatus == 1) ? Row(
                  ...
                  children: [
                    ...
                    Text('(+) ${PriceConverter.convertPrice(_dmTips, discount: (0),discountType: ('jh'))}', style: robotoRegular),
                  ],
                ) : SizedBox(),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  _deliveryCharge > 0 ? Text(
                    '(+) ${PriceConverter.convertPrice(_deliveryCharge, discount: (0),discountType: ('jh'))}', style: robotoRegular,
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Text(
                    PriceConverter.convertPrice(_total, discount: (0),discountType: ('jh')),
