...
import 'package:houseofdelevryy/view/base/address_details.dart';
import 'package:houseofdelevryy/view/base/custom_divider.dart';
      ...
      child: (!_takeAway && track.deliveryMan == null) ? Padding(
        ...
        Row(children: [
          ...
          Expanded(
            ...
            ) : AddressDetails(addressDetails: track.deliveryAddress, key: Key(orderId),),
          ),
