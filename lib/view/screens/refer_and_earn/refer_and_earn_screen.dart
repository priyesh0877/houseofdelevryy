...
class ReferAndEarnScreen extends StatefulWidget {
  const ReferAndEarnScreen({required Key key}) : super(key: key);
                      ...
                      child: Row(mainAxisSize: MainAxisSize.min, children: [
                        ...
                        Column(children: [
                          ...
                          SizedBox(
                            ...
                            child: Text(
                                'get'.tr +
                                    ' ${PriceConverter.convertPrice(Get.find<SplashController>().configModel != null ? Get.find<SplashController>().configModel.refEarningExchangeRate.toDouble() : 0.0, discount: (0), discountType: 'kj')} ' +
                                    'on_joining'.tr,
                                style: robotoRegular.copyWith(
                                    fontSize: Dimensions.fontSizeSmall),
                                textAlign: TextAlign.center),
