...
class _AllRestaurantScreenState extends State<AllRestaurantScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: widget.isPopular ? 'popular_restaurants'.tr : '${'new_on'.tr} ${AppConstants.APP_NAME}', onBackPressed: (){},),
      body: RefreshIndicator(
        ...
        child: Scrollbar(child: SingleChildScrollView(child: Center(child: SizedBox(
          ...
          child: GetBuilder<RestaurantController>(builder: (restController) {
            return ProductView(
              isRestaurant: true, products: RxList(), noDataText: 'no_restaurant_available'.tr,
