            ...
            ResponsiveHelper.isDesktop(context) ? SliverToBoxAdapter(
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                background: CustomImage(
                  ...
                  image: '${Get.find<SplashController>().configModel.baseUrls.campaignImageUrl}/${widget.campaign.image}', height: double.infinity, width: double.infinity,
                ),
              ),
            ),
            ...
            SliverToBoxAdapter(child: Center(child: Container(
              ...
              child: Column(children: [
                ...
                ProductView(
                  ...
                  restaurants: campaignController.campaign != null ? campaignController.campaign.restaurants : null, noDataText: '', type: '', onVegFilterTap: (String type) {  },
                ),
