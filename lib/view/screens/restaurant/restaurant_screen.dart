...
import 'package:houseofdelevryy/data/model/response/category_model.dart';
...
import 'package:houseofdelevryy/view/base/bottom_cart_widget.dart';
...
import 'package:houseofdelevryy/view/screens/restaurant/widget/restaurant_description_view.dart';
...
class _RestaurantScreenState extends State<RestaurantScreen> {
  ...
  void initState() {
    ...
    Get.find<RestaurantController>().getRestaurantDetails(Restaurant(
      ...
      address: '',
      zoneId: hashCode,
      minimumOrder: double.infinity,
      currency: '',
      freeDelivery: mounted,
      coverPhoto: '',
      delivery: mounted,
      takeAway: mounted,
      scheduleOrder: mounted,
      avgRating: double.infinity,
      tax: double.infinity,
      ratingCount: hashCode,
      selfDeliverySystem: hashCode,
      posSystem: mounted,
      open: hashCode,
      active: mounted,
      deliveryTime: '',
      ...
      nonVeg: hashCode,
      schedules: [],
      minimumShippingCharge: double.infinity,
      perKmShippingCharge: double.infinity,
      discount: null,
    ));
                                      ...
                                      children: [
                                        Text(
                                          _restaurant.discount.discountType ==
                                              ...
                                              : '${PriceConverter.convertPrice(_restaurant.discount.discount, discount: 0, discountType: 'k')} OFF',
                                        ...
                                        Text(
                                          _restaurant.discount.discountType ==
                                              ...
                                              : '${'enjoy'.tr} ${PriceConverter.convertPrice(_restaurant.discount.discount, discount: 0, discountType: 'k')}'
                                        ...
                                        _restaurant.discount.minPurchase != 0
                                            ? Text(
                                                '[ ${'minimum_purchase'.tr}: ${PriceConverter.convertPrice(_restaurant.discount.minPurchase, discount: 0, discountType: 'k')} ]',
                                        ...
                                        _restaurant.discount.maxDiscount != 0
                                            ? Text(
                                                '[ ${'maximum_discount'.tr}: ${PriceConverter.convertPrice(_restaurant.discount.maxDiscount, discount: 0, discountType: 'k')} ]',
                                                style: robotoRegular.copyWith(
                                                    fontSize: Dimensions
                                                        .fontSizeExtraSmall,
                                                    color: Theme.of(context)
