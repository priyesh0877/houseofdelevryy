...
import 'package:houseofdelevryy/view/screens/review/widget/deliver_man_review_widget.dart';
import 'package:houseofdelevryy/view/screens/review/widget/product_review_widget.dart';
...
class _RateReviewScreenState extends State<RateReviewScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(title: 'rate_review'.tr, onBackPressed: (){},),
