            ...
            return Container(
              ...
              child: Column(children: [
                  ...
                  children: [
                    ...
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        Text(PriceConverter.convertPrice(widget.orderDetailsList[index].foodDetails.price, discount: 0,discountType: 'k'), style: robotoBold),
                      ],
                    )),
                    Row(children: [
                      Text(
                ...
                MyTextField(
                  ...
                  onChanged: (text) => productController.setReview(index, text), onTap: (){}, controller: TextEditingController(), focusNode: FocusNode(), nextFocus: FocusNode(), onSubmit: (){}, key: GlobalKey(),
                ),
                SizedBox(height: 20),
