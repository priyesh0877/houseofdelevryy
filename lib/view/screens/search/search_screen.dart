...
import 'package:houseofdelevryy/view/screens/search/widget/filter_widget.dart';
import 'package:houseofdelevryy/view/screens/search/widget/search_field.dart';
import 'package:houseofdelevryy/view/screens/search/widget/search_result_widget.dart';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
            ...
            return Column(children: [
              ...
              Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Row(children: [
                ...
                Expanded(child: SearchField(
                  ...
                  onSubmit: (text) => _actionSearch(searchController, true), onChanged: (){},
                )),
                CustomButton(
                      ...
                      return InkWell(
                        onTap: () {
                          ResponsiveHelper.isMobile(context) ? Get.bottomSheet(
                            ProductBottomSheet(product: searchController.suggestedFoodList[index], cartIndex: hashCode,),
        ...
        bottomNavigationBar: GetBuilder<CartController>(builder: (cartController) {
          return cartController.cartList.length > 0 && !ResponsiveHelper.isDesktop(context) ? BottomCartWidget(key: GlobalKey(),) : SizedBox();
        }),
      ),
    );
  }
