...
class SearchField extends StatefulWidget {
  ...
  SearchField({required this.controller, required this.hint, required this.suffixIcon, required this.iconPressed, required this.onSubmit, required this.onChanged});
