...
import 'package:houseofdelevryy/data/model/response/cart_model.dart';
...
import 'package:houseofdelevryy/view/screens/address/widget/address_widget.dart';
import 'package:houseofdelevryy/view/screens/cart/widget/delivery_option_button.dart';
import 'package:houseofdelevryy/view/screens/checkout/widget/address_dialogue.dart';
import 'package:houseofdelevryy/view/screens/checkout/widget/payment_button.dart';
import 'package:houseofdelevryy/view/screens/checkout/widget/tips_widget.dart';
...
class _SubscriptionCheckoutScreenState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title: 'Subscription Checkout'.tr,
        onBackPressed: () {},
      ),
      body: _isLoggedIn
                                              ...
                                              children: [
                                                ...
                                                Center(
                                                  child: Text('delivery_charge'
                                                          .tr +
                                                      ': ' +
                                                      '${(orderController.orderType == 'take_away' || (orderController.deliverySelectIndex == 0 ? restController.restaurant.freeDelivery : true)) ? 'free'.tr : _charge != -1 ? PriceConverter.convertPrice(orderController.deliverySelectIndex == 0 ? _charge : _deliveryCharge, discount: 0, discountType: 'rf') : 'calculating'.tr}'),
                                                ),
                                                          ...
                                                          if (_couponCode
                                                            ...
                                                            couponController
                                                              ...
                                                              if (discount >
                                                                  0) {
                                                                showCustomSnackBar(
                                                                  '${'you_got_discount_of'.tr} ${PriceConverter.convertPrice(discount, discount: 0, discountType: 'kj')}',
                                                                  isError:
                                                                      false,
                                                                );
                                                              }
                                            ...
                                            Row(
                                                ...
                                                children: [
                                                  Text('discount'.tr,
                                                      style: robotoRegular),
                                                  Text(
                                                      '(-) ${PriceConverter.convertPrice(_discount, discount: 0, discountType: 'k')}',
                                                      style: robotoRegular),
                                                ]),
                                            SizedBox(
                                                height: Dimensions
                                                    ...
                                                    Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          (couponController
                                                              ...
                                                              : Text(
                                                                  '(-) ${PriceConverter.convertPrice(couponController.discount, discount: 0, discountType: 'kh')}',
                                                                  style:
                                                                      robotoRegular,
                                                                ),
                                                        ]),
                                            ...
                                            Row(
                                                ...
                                                children: [
                                                  Text('vat_tax'.tr,
                                                      style: robotoRegular),
                                                  Text(
                                                      '(+) ${PriceConverter.convertPrice(_tax, discount: 0, discountType: 'k')}',
                                                      style: robotoRegular),
                                                ]),
                                            SizedBox(
                                                height: Dimensions
                                                ...
                                                ? Row(
                                                    ...
                                                    children: [
                                                      Text(
                                                          ...
                                                          style: robotoRegular),
                                                      Text(
                                                          '(+) ${PriceConverter.convertPrice(orderController.tips, discount: 0, discountType: 'jh')}',
                                                          style: robotoRegular),
                                                    ],
                                                  )
                                                : SizedBox.shrink(),
                                                ...
                                                children: [
                                                  ...
                                                  _deliveryCharge == -1
                                                      ...
                                                      : (_deliveryCharge == 0 ||
                                                          ...
                                                          : Text(
                                                              '(+) ${PriceConverter.convertPrice(_deliveryCharge, discount: 0, discountType: 'k')}',
                                                              style:
                                                                  robotoRegular,
                                                            ),
                                                ]),
                                          ...
                                          if (!_isCashOnDeliveryActive &&
                                            ...
                                            showCustomSnackBar(
                                                '${'minimum_order_amount_is'.tr} ${restController.restaurant.minimumOrder}');
                                                          ...
                                                          .selectedDateSlot ==
                                                      0 &&
                                                  _todayClosed) || (orderController
                                                          .selectedDateSlot == 1 &&
                                                  _tomorrowClosed)) {
                                            showCustomSnackBar(
                                                'restaurant_is_closed'.tr);
                                          } else if (orderController
                                                      .timeSlots == null || orderController
                                                      .timeSlots.length == 0) {
                                            if (restController
                                            ...
                                            Map myInput = {
                                              ...
                                              'couponDiscountTitle': Get.find<
                                                              CouponController>()
                                                          .discount >0 ? Get.find<CouponController>().coupon.title
                                                  : null,
    ...
    if (isSuccess) {
      ...
      if (Get.find<OrderController>().paymentMethodIndex == 0 ||
        ...
        if (GetPlatform.isWeb) {
          ...
          String selectedUrl =
              '${AppConstants.BASE_URL}/subscribe-payment-mobile?order_id=$orderID&customer_id=${Get.find<UserController>().userInfoModel.id}&&callback=$protocol//$hostname${RouteHelper.orderSuccess}?id=$orderID&amount=$amount&status=';
