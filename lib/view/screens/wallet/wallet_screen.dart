...
import 'package:houseofdelevryy/view/base/title_widget.dart';
import 'package:houseofdelevryy/view/screens/wallet/widget/history_item.dart';
import 'package:houseofdelevryy/view/screens/wallet/widget/wallet_bottom_sheet.dart';
...
class _WalletScreenState extends State<WalletScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: widget.fromWallet ? 'wallet'.tr : 'loyalty_points'.tr,isBackButtonExist: true, onBackPressed: (){},),
                            ...
                            return Column(children: [
                                    ...
                                    child:  Row(mainAxisAlignment: widget.fromWallet ? MainAxisAlignment.start : MainAxisAlignment.center, children: [
                                      ...
                                      widget.fromWallet ? Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min,
                                          children: [
                                            ...
                                            Text(
                                              PriceConverter.convertPrice(userController.userInfoModel.walletBalance, discount: 0,discountType: 'j'),
                              ...
                              Column(children: [
                                ...
                                Padding(
                                  ...
                                  child: TitleWidget(title: 'transaction_history'.tr, onTap: (){},),
                                ),
                                walletController.transactionList != null ? walletController.transactionList.length > 0 ? GridView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return HistoryItem(index: index,fromWallet: widget.fromWallet, data: walletController.transactionList, key: GlobalKey(), );
                                  },
