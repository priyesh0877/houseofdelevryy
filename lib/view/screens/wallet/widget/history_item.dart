import 'package:houseofdelevryy/data/model/response/wallet_model.dart';
        ...
        children: [
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            fromWallet ? Text(data[index].transactionType == 'order_place'
                ? PriceConverter.convertPrice(data[index].debit + data[index].adminBonus, discount: 0,discountType: 'k')
                : PriceConverter.convertPrice(data[index].credit + data[index].adminBonus, discount: 0,discountType: 'k'),
